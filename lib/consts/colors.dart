...
class ColorsConsts {
  ...
  static Color gradiendFStart = Color(0xFFFDD835); //purpleAccent 100
  static Color gradiendFEnd = Color(0xFFF57F17); //purple 100
  ...
  static Color kHighlightColor = Color(0xff996300);
}
